...
DAT.Globe = function (container, options) {
    ...
    var controlPanel = new function () {
        this.AutoRotation = !!(options.autoRotation == undefined || options.autoRotation);
        this.RegionsAutoCycle = (!(options.regionsAutoCycle == undefined || !options.regionsAutoCycle));
        this.BattleMode = (!(options.battleMode == undefined || !options.battleMode));
        this.StarsVisible = !!(options.starsVisible == undefined || options.starsVisible);
        this.DayMode = (!(options.dayMode !== undefined && options.dayMode == false));
        this.ShowTooltip = (!(options.showTooltip !== undefined && options.showTooltip == false));
        this.ShowStatistic = (!(options.showStatistic !== undefined && options.showStatistic == false));
        this.ShowStatTable = !!(options.showStatTable !== undefined && options.showStatTable == true);
